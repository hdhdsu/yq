function showTime() { 
	...
	// new Date()里面的参数改成你们在一起的那一天就好啦，
	var startDate = new Date(2021, 7 ,3);//改这里
	...
	var currentTimeString = "Dear :<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----love you   2021-8-3</c>"; //2021-8-3改成你们在一起的那一天就好啦
